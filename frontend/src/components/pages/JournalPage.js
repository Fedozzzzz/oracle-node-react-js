...
import {addClient, deleteClient, editClient, fetchClients} from "../../ajax/clients";
import DeleteModal from "../modals/common/DeleteModal";
import CreateClientModal from "../modals/CreateClientModal";
import {addJournalNote, deleteJournalNote, editJournalNote, fetchJournal} from "../../ajax/journal";
import {fetchBooks, fetchBooksAndTypes, getDayCount} from "../../ajax/books";
        ...
        return journal.map(j => (
            <tr key={j.ID}>
                ...
                <th className='flex-column justify-content-center'>
                    <button type="button" className="col btn btn-outline-danger btn-sm"
                            onClick={() => this.onDelete(j.ID)}>Delete
                    </button>
                    <button type="button" className="col btn btn-outline-warning btn-sm"
                            onClick={() => this.onModify(j)}>Edit
                    </button>
                </th>
            </tr>
        ));
