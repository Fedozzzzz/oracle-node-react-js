...
import {addBook, deleteBook, editBook, fetchBooks, fetchThreePopularBooks} from "../../ajax/books";
...
class BooksPage extends Component {
    ...
    onGetThreePopularBooks = async () => {
        try {
            ...
            console.log(res);
            this.setState({threePopularBooks: res.threePopularBooks, showInfoDialog: true})
        } catch (e) {
            this.setState({error: e})
        }
    };
    ...
    onExport = () => {
        ...
        if (threePopularBooks) fileDownload(JSON.stringify(threePopularBooks), 'threePopularBooks.json');
    };

    renderExportButton = () => {
        return (
            <div>
                <Button variant="info" onClick={this.onExport}>Export</Button>
            </div>)
    };
            ...
            <div>
                ...
                <main role="main" className="ml-sm-auto px-5 p-4">
                    ...
                    <button type="button" className="btn btn-outline-danger btn-sm mx-2"
                            onClick={this.onGetThreePopularBooks}>Show three Popular Books
                    </button>
